...
const national = paycheckPage({
  ...
  lede: "Take-home pay after federal tax, FICA and your own state rate.",
  stateRatePct: 0,
...
const texas = paycheckPage({
  ...
  lede: "Texas take-home pay after federal tax and FICA. No state income tax.",
  stateRatePct: 0,
  lockState: true,
...
const florida = paycheckPage({
  ...
  lede: "Florida has no state income tax. See your pay after federal tax and FICA.",
  stateRatePct: 0,
  lockState: true,
