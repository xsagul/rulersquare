...
const national = paycheckPage({
  ...
  lede: "Estimate take-home pay after federal tax, FICA and selected deductions. Add your own effective state tax rate.",
  stateRatePct: 0,
...
const texas = paycheckPage({
  ...
  lede: "Estimate Texas take-home pay after federal tax, FICA and selected deductions, with no state wage income tax.",
  stateRatePct: 0,
  lockState: true,
