...
const salaryToHourly = wagePage({
  ...
  lede: "Convert a salary to an hourly rate, and back, using your real hours.",
  amountLabel: "Salary",
  defaultPer: "year",
...
const annualIncome = wagePage({
  ...
  lede: "Turn any pay rate into a yearly figure, with overtime included.",
...
const payRate = wagePage({
  ...
  lede: "Enter any pay rate and see every other one, hourly through yearly.",
  amountLabel: "Pay rate",
  defaultPer: "week",
  headline: "Weekly pay",
  headlineId: "r-weekly",
